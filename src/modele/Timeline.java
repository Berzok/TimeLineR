 ...
 */
	...
	public static Timeline generateTimeline(Integer n)
		...
		Evenement eventDeux = new Evenement("Fashion", new Date(21, 6, 1983), "Nicolas Cage se lance à l'attaque du monde de la mode !", 2);
		eventDeux.setImageURL("images/Fashion.jpg");
		eventDeux.setChCol(1);
		
		
		Evenement eventTrois = new Evenement("Capillarité", new Date(12, 10, 1999), "Nicolas Cage devient à moitié aigle et se prépare à prendre son envol !", 1);
		eventTrois.setImageURL("images/cheveux.jpg");
		eventTrois.setChCol(2);
		
		
		Evenement eventQuatre = new Evenement("Jedi", new Date(13, 4, 2012), "Après avoir enfin maîtrisé la Force, Nicolas Cage devint le plus grand des chevaliers Jedi", 2);
